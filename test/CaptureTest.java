...
public class CaptureTest {
	...
	public void testapture() {
		...
		assertEquals("Original Empty", "null", chessBoard.getChessPieceInPosition(testPosition[3]).type);
		assertEquals("King Replaced - type", "white", chessBoard.getChessPieceInPosition(testPosition[4]).type);
		assertEquals("King Replaced - name", "bishop", chessBoard.getChessPieceInPosition(testPosition[4]).name);
	}
