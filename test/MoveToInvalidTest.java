...
public class MoveToInvalidTest {
	...
	public void moveToEmptyTest() {
		...
		assertEquals("Still chess piece name", "pawn", chessBoard.getChessPieceInPosition(testPosition[0]).name);
		assertEquals("Still chess piece type", "white", chessBoard.getChessPieceInPosition(testPosition[0]).type);
